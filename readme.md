...
Person.protype 
=> personprototype.constructor=> person function 
...
The concept of js moving the varialbe and function declarations to the top of the script is called as function hoisting.
...
## Collections in JS
    ...
    Collection is used to manage a group of values or attributes.

### Map

Map: Key vs Value pair
